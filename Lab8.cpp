...
int main() {
	Complex<double> num1(0, 0);
	Complex<double> num2(0, 1);
	Complex<double> num3(1, 0);
	Complex<double> num4(1, 1);
	cout << "testing output" << endl;
	num1.print(); num2.print(); num3.print(); num4.print();
	cout << "num1 output" << endl;
	num1.print();
	cout << "num4 output" << endl;
	num4.print();
	cout << "num1 += num4" << endl;
	(num1 += num4).print();
	cout << "num1 *= num4" << endl;
